    ...
    public function extractZip()
    {
        ...
        foreach ($fileList as $file) {
            if ($file['type'] == 'file') {
                ...
                chmod($this->file_dir . eZSys::fileSeparator() . OCCSVImportHandler::cleanFileName($file['name']), octdec('0777'));
            }
        }
    ...
    public function make_csvimportchildren($parameters)
    {
        ...
        foreach ($data as $d) {
            ...
            foreach ($objects as $index => $object) {
                $remoteID = substr($parameters['guid'], 0, 85) . '_children_' . $index;
                ...
                if ($fileHandler->exists()) {
                    ...
                    if (!isset($content->fields[$parameters['language']])) {
                    ...
                    $cli->error($fileName . ' non trovato.');
                    //print_r($parameters);
                }
            }
        }
