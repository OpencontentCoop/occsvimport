...
<div class="container my-5 bg-white rounded-top p-5">
    <div class="row">
        <div class="col-12">
            ...
            {else}
                {if $context}
                    <p>Imposta lo spreadsheet per esportare i dati</p>
                {else}
                    <p>Imposta lo spreadsheet per importare i dati</p>
                {/if}
            {/if}
            ...
            {else}
                <form action="{'/migration/dashboard'|ezurl(no)}" method="post">
                    <div class="form-group">
                        <label for="migration_spreadsheet">Inserisci l'identificatore dello spreadsheet</label>
                        <p>Lo spreadsheet deve essere condiviso con l'utente <code>todo</code> in modalità Editor</p>
